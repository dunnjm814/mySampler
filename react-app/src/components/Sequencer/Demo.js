    ...
    <>
      ...
      <section className="instructions">
        <div>
          <h3>Instructions: </h3>
          <p>
            First, select a key from the drop down. <br />
            <br />
            Then make selections on the grid where <br />
            You would like to arrange the notes.
            <br />
            <br />
            As you decrease in row number,
            <br />
            The lower in an musical octave a played note will be.
            <br />
            <br />
            Press play and listen to your arrangement!
            <br />
            You can update the arrangement while the sequence is playing.
            <br />
          </p>
          <h3>Have Fun!</h3>
        </div>
